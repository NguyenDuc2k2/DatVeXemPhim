...
export default function Footer() {
    ...
    const arrHeThongRap = _.uniq(heThongRap, (heThongRapChieu) => _.pick(heThongRapChieu, ['maHeThongRap', 'tenHeThongRap', 'logo']));
   
    return (
        <footer className="py-6 dark:bg-gray-800 dark:text-gray-50 mt-10">
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold text-white">Nguyễn Huỳnh Đức</span>
                        </a>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        <p className="pb-1 text-lg font-medium">Nhà Tài Trợ</p>
                        <ul className='grid grid-cols-2'>
                            {arrHeThongRap.map((htr, index) => {
                                return <li key={index}>
                                    <img className='w-12 h-12' src={htr.logo} alt='' />
                                </li>
                            })}
                        </ul>
                    </div>
                ...
                <div className="grid justify-center pt-6 lg:justify-between">
                    <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
                        <span>©2022 Nguyễn Huỳnh Đức</span>
